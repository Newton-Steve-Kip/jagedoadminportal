...
import OrgCustomerHistoryTable from '@/app/shared/admin/dashboard/tables/history-tables/customer-organization';
...
export default function EditOrganizationCustomerForm({ slug }: EditFormProps) {
  ...
  return (
    <div className="@container">
      ...
      <OrgCustomerHistoryTable className="mt-6" />
    </div>
  );
}
