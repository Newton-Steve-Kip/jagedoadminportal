...
import IndividualHistoryTable from '@/app/shared/admin/dashboard/tables/history-tables/customer-individual';
...
export default function EditIndividualCustomerForm({ slug }: EditFormProps) {
  ...
  return (
    <div className="@container">
      ...
      <IndividualHistoryTable className="mt-6" />
    </div>
  );
}
